...
```
Even not counting max related security incidents - tract 008100 (Gateway) is a big hot spot. 
...
Where have the homicides occured? 


Sleepers / riders without destination 
```{r}
...
Creating features from `comments` column 
